...
#echo " "; echo "Setting resolution on monitors to 1024x768 to avoid Mig Alley graphics problems";
...
echo "When Mig Alley starts, select PREFERENCES and set graphics resolution to 1024x768."
